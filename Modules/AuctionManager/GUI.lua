...
function AuctionGUI:Initialize()
    ...
    local dkp_title = f:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
    ...
    local bid_counter = bid_counter_frame:CreateFontString(nil, 'OVERLAY', 'BossEmoteNormalHuge')
...
function AuctionGUI:RefreshBidders()
    ...
    local createProspectFrame = function()
        ...
        f.bid = f:CreateFontString(nil, 'OVERLAY', 'GameFontNormalRight')
        f.name:SetHeight(18)
        f.bid:SetHeight(18)
