...
Loot.priority = {
    ...
    ["Sinew"]={"Leaf > No Leaf"},
    ["Spaulders of the Grand Crusader"]={"Paladin (Ret)"},
    ["Necro-Knight's Garb"]={"Free Roll"},
    ["Ghoul Skin Tunic"]={"Druid (Feral) > Warrior (DPS)"},
    ["Girdle of Elemental Fury"]={"Free Roll"},
    ["Belt of the Grand Crusader"]={"Free Roll"},
    ["Leggings of the Grand Crusader"]={"Free Roll"},
    ["Ring of the Eternal Flame"]={"Mage > Warlock"},
    ["Stygian Buckler"]={"Free Roll"},
    ["Misplaced Servo Arm"]={"Warrior (DPS) > Rogue"},
    ["Desecrated Bindings (Priest, Mage, Warlock)"]={"Priest = Mage = Warlock  * Offtanks Warriors may qualify as Tank warriors"},
    ["Desecrated Wristguards (Paladin, Hunter, Druid)"]={"Paladin = Druid (Resto) = Hunter"},
    ["Desecrated Bracers (Warrior, Rogue)"]={"Warrior (Tank)* = Rogue > Warrior (DPS)  Summary: equal prio except (1) Priests get prio on pants (2) DPS warriors do not get prio on T3 unless they are designated offtanks"},
    ["Desecrated Gloves (Priest, Mage, Warlock)"]={"Priest = Mage = Warlock"},
    ["Desecrated Handguards (Paladin, Hunter, Druid)"]={"Paladin = Druid (Resto) = Hunter"},
    ["Desecrated Gauntlets (Warrior, Rogue)"]={"Warrior (Tank)* = Rogue > Warrior (DPS)"},
    ["Desecrated Shoulderpads (Priest, Mage, Warlock)"]={"Priest = Mage = Warlock"},
    ["Desecrated Spaulders (Paladin, Hunter, Druid)"]={"Paladin = Druid (Resto) = Hunter"},
    ["Desecrated Pauldrons (Warrior, Rogue)"]={"Warrior (Tank)* = Rogue > Warrior (DPS)"},
    ["Desecrated Circlet (Priest, Mage, Warlock)"]={"Priest = Mage > Warlock"},
    ["Desecrated Headpiece (Paladin, Hunter, Druid)"]={"Paladin = Druid (Resto) = Hunter"},
    ["Desecrated Helmet (Warrior, Rogue)"]={"Warrior (Tank)* = Rogue > Warrior (DPS)"},
    ["Desecrated Belt (Priest, Mage, Warlock)"]={"Priest = Mage = Warlock"},
    ["Desecrated Girdle (Paladin, Hunter, Druid)"]={"Paladin = Druid (Resto) = Hunter"},
    ["Desecrated Waistguard (Warrior, Rogue)"]={"Warrior (Tank)* = Rogue > Warrior (DPS)"},
    ["Desecrated Leggings (Priest, Mage, Warlock)"]={"Priest > Mage = Warlock"},
    ["Desecrated Legguards (Paladin, Hunter, Druid)"]={"Paladin = Druid (Resto) = Hunter"},
    ["Desecrated Legplates (Warrior, Rogue)"]={"Warrior (Tank)* = Rogue > Warrior (DPS)"},
    ["Desecrated Sandals (Priest, Mage, Warlock)"]={"Priest = Mage > Warlock"},
    ["Desecrated Boots (Paladin, Hunter, Druid)"]={"Paladin = Druid (Resto) = Hunter"},
    ["Desecrated Sabatons (Warrior, Rogue)"]={"Warrior (Tank)* = Rogue > Warrior (DPS)"},
    ["Desecrated Robes (Priest, Mage, Warlock)"]={"Priest = Mage > Warlock"},
    ["Desecrated Tunic (Paladin, Hunter, Druid)"]={"Paladin = Druid (Resto) = Hunter"},
    ["Desecrated Breastplate (Warrior, Rogue)"]={"Warrior (Tank)* = Rogue > Warrior (DPS)"},
    ["Cryptfiend Silk Cloak"]={"Druid (Feral) > Warrior (Tank) > MS>OS"},
    ["Wristguards of Vengeance"]={"MS>OS"},
    ["Band of Unanswered Prayers"]={"MS>OS"},
    ["Gem of Nerubis"]={"Free Roll"},
    ["Malice Stone Pendant"]={"Shadow Priest"},
    ["Icebane Pauldrons"]={"Free Roll"},
    ["The Widow's Embrace"]={"MS>OS"},
    ["Widow's Remorse"]={"Warrior (Tank) > MS>OS"},
    ["Pendant of Forgotten Names"]={"MS>OS"},
    ["Crystal Webbed Robe"]={"Shadow Priest > Warlock = Mage"},
    ["Kiss of the Spider"]={"Druid (Feral) = Rogue = Warrior > Paladin (Ret) = Hunter  *1.5x to get equal prio"},
    ["Wraith Blade"]={"Warlock = Mage"},
    ["Maexxna's Fang"]={"Warrior (DPS) = Rogue  * Non Human"},
    ["Cloak of Suturing"]={"MS>OS"},
    ["Band of Reanimation "]={"Hunter"},
    ["Wand of Fates"]={"Warlock > Mage = Shadow Priest"},
    ["Severance"]={"MS>OS"},
    ["Toxin Injector"]={"MS>OS"},
    ["Midnight Haze"]={"MS>OS"},
    ["The End of Dreams"]={"Shadow Priest = Druid"},
    ["Rime Covered Mantle"]={"Mage > Warlock"},
    ["Gluth's Missing Collar"]={"MS>OS"},
    ["Digested Hand of Power"]={"Free Roll"},
    ["Death's Bargain"]={"MS>OS"},
    ["Claymore of Unholy Might"]={"MS>OS"},
    ["Plated Abomination Ribcage"]={"MS>OS"},
    ["Leggings of Polarity"]={"Mage = Warlock"},
    ["The Castigator"]={"Warrior (DPS)  *Human Warrior"},
    ["Spire of Twilight"]={"MS>OS"},
    ["Cloak of the Scourge"]={"MS>OS"},
    ["Band of the Inevitable"]={"Warlock > Mage = Shadow Priest"},
    ["Noth's Frigid Heart"]={"MS>OS"},
    ["Libram of Light"]={"Free Roll"},
    ["Hatchet of Sundered Bone"]={"Warrior (DPS) > Hunter  *non-human"},
    ["Preceptor's Hat"]={"Shadow Priest > MS>OS"},
    ["Necklace of Necropsy"]={"MS>OS"},
    ["Legplates of Carnage"]={"MS>OS"},
    ["Band of Unnatural Forces"]={"Druid (Feral) = Rogue = Warrior (DPS) > Hunter"},
    ["Ring of Spiritual Fervor"]={"MS>OS"},
    ["The Eye of Nerub"]={"Hunter > MS>OS"},
    ["Brimstone Staff"]={"Warlock = Mage > Shadow Priest"},
    ["Veil of Eclipse"]={"Shadow Priest"},
    ["Girdle of the Mentor"]={"MS>OS"},
    ["Signet of the Fallen Defender"]={"Druid (Feral)"},
    ["Idol of Longevity"]={"Free Roll"},
    ["Wand of the Whispering Dead"]={"MS>OS"},
    ["Iblis, Blade of the Fallen Seraph"]={"Warrior (DPS) = Rogue > Hunter  *Human Rogues"},
    ["Sadist's Collar"]={"MS>OS"},
    ["The Soul Harvester's Bindings"]={"MS>OS"},
    ["Boots of Displacement"]={"MS>OS"},
    ["Leggings of Apocalypse"]={"Druid (Feral) > MS>OS"},
    ["Seal of the Damned"]={"Warlock = Mage"},
    ["Warmth of Forgiveness"]={"Priest"},
    ["Soulstring"]={"MS>OS"},
    ["Maul of the Redeemed Crusader"]={"Paladin (Ret)"},
    ["Corrupted Ashbringer"]={"Paladin (Ret)"},
    ["Epic Shoulder Enchants"]={"BiS Item /Roll"},
    ["Cloak of the Necropolis"]={"Warlock = Mage"},
    ["Shroud of Dominion"]={"Warrior (DPS) = Rogue = Hunter"},
    ["Glyph of Deflection"]={"MS>OS"},
    ["Eye of the Dead"]={"MS>OS"},
    ["Slayer's Crest"]={"Warrior (DPS) = Rogue = Hunter > Paladin (Ret)"},
    ["The Restrained Essence of Sapphiron"]={"Warlock = Mage = Shadow Priest"},
    ["Sapphiron's Left Eye"]={"Warlock = Mage > MS>OS"},
    ["Sappirons's Right Eye"]={"MS>OS"},
    ["The Face of Death"]={"Warrior (Tank) > Warrior (DPS) > MS>OS"},
    ["Claw of the Frost Wyrm"]={"Hunter"},
    ["The Phylactery of Kel'Thuzad"]={"MS>OS"},
    ["Tier Class 9/9 Rings"]={"MS>OS"},
    ["Gem of Trapped Innocents"]={"Warlock = Mage"},
    ["Stormrage's Talisman of Seething"]={"Warrior (DPS) = Paladin (Ret)"},
    ["Nerubin Slavemaker"]={"Hunter > MS>OS"},
    ["Doomfinger"]={"Mage > Warlock"},
    ["Shield of Condemnation"]={"MS>OS"},
    ["Kingsfall"]={"Rogue = Warrior (DPS) > Hunter  * Non-human warrior"},
    ["Hammer of the Twisting Nether"]={"MS>OS"},
    ["Gressil, Dawn of Ruin"]={"Rogue = Warrior (DPS)  *sword rogue"},
    ["The Hungering Cold"]={"Rogue = Warrior (DPS) = Warrior (Tank)"},
    ["Might of Menethil"]={"Paladin (Ret) > MS>OS"},
    ["Soulseeker"]={"Mage = Warlock"},
    ["Atiesh, Greatstaff of the Guardian"]={"1. Outstanding member of each class rolls off of it."},
}